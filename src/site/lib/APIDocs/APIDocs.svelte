<script lang="ts">
	...
	import type { DispatchedEvent, ForwardedEvent, ParsedComponent } from './ParsedComponent';
...
{#if data.rest_props}
	<InfoBar severity="information" title="This component uses $$restProps.">
		...
		<Button
			slot="action"
			variant="accent"
			href="https://svelte.dev/docs#template-syntax-attributes-and-props">More Info
		</Button
		>
	</InfoBar>
{/if}
